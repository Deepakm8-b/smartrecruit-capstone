...
<head>
<meta charset="UTF-8">
<title>Commission - SmartRecruit</title>
<style>
...
<div class="container">
    ...
    <div class="empty">
        ...
        <p style="font-size: 13px; margin-top: 8px;">Commissions are earned when you hire referred students through SmartRecruit</p>
    </div>
</div>
